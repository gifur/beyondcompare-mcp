...
const BACKEND_NAME: &str = "beyondcompare-mcp-backend.exe";
const BACKEND_PORT: u16 = 10841;
const BACKEND_TAG: &str = "beyondcompare-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "BEYONDCOMPARE_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 10841",
    ...
    Ok(format!("Backend starting on port 10841"))
}
