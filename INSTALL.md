...
4. Start the server:
   ...
   uv run python -m beyondcompare_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn beyondcompare_mcp.server:app --port 10841
   ```
5. Open `http://localhost:10841` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/beyondcompare-mcp/issues) |
